...
module TwitterAds
  class AppList
    ...
    RESOURCE_COLLECTION = "/#{TwitterAds::API_VERSION}/accounts/%{account_id}/app_lists".freeze # @api private
    RESOURCE            = "/#{TwitterAds::API_VERSION}/accounts/%{account_id}/app_lists/%{id}".freeze # @api private
